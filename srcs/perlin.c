...
t_2vecf		get_2drandom_gradient(const int permutation[512], const t_2vecf gradient[8], int x, int y)
{
	return (gradient[ + permutation[y + permutation[x]] % 8]);
}
...
//{
	...
	const t_2vecf gradient[8] =
		{assign_2vecf(1,0), assign_2vecf(0,1)
		, assign_2vecf(-1,0), assign_2vecf(0,-1)
		, assign_2vecf(M_SQRT2, M_SQRT2), assign_2vecf(M_SQRT2,-M_SQRT2)
		, assign_2vecf(-M_SQRT2, M_SQRT2), assign_2vecf(-M_SQRT2,-M_SQRT2)};
//		, assign_3vecf(1,0,-1), assign_3vecf(-1,0,-1)
//		, assign_2vecf(0,1,1), assign_3vecf(0,-1,1), assign_3vecf(0,1,-1), assign_3vecf(0,-1,-1)
//		, assign_2vecf(1,1,0), assign_3vecf(-1,1,0), assign_3vecf(0,-1,1), assign_3vecf(0,-1, -1)};
...
//	text_coord.val[1]*=8; //for resolution
	...
	t_2vecf	int_part = assign_2vecf((int)inter_point.val[0], (int)inter_point.val[1]);
...
//	printf("text_coord %f %f\n", text_coord.val[0], text_coord.val[1]);
	...
	t_2vecf floating_part = assign_2vecf(inter_point.val[0] - int_part.val[0], inter_point.val[1] - int_part.val[1]);
	int_part.val[0] = (int)int_part.val[0] & 255;
	int_part.val[1] = (int)int_part.val[1] & 255;

	double	g00 = dot_product_2vecf(get_2drandom_gradient(permutation, gradient, (int)int_part.val[0], (int)int_part.val[1]), floating_part);
	double	g01 = dot_product_2vecf(get_2drandom_gradient(permutation, gradient, (int)int_part.val[0], (int)int_part.val[1] + 1), assign_2vecf(floating_part.val[0], floating_part.val[1] - 1));
	double	g10 = dot_product_2vecf(get_2drandom_gradient(permutation, gradient, (int)int_part.val[0] + 1, (int)int_part.val[1]), assign_2vecf(floating_part.val[0] - 1, floating_part.val[1]));
	double	g11 = dot_product_2vecf(get_2drandom_gradient(permutation, gradient, (int)int_part.val[0] + 1, (int)int_part.val[1] + 1), assign_2vecf(floating_part.val[0] - 1, floating_part.val[1] - 1));

//	double	g100 = dot_product_3vecf(get_2drandom_gradient(permutation, gradient, (int)int_part.val[0] + 1, (int)int_part.val[1], (int)int_part.val[2]), assign_3vecf(floating_part.val[0] - 1.0, floating_part.val[1], floating_part.val[2]));
//	double	g101 = dot_product_3vecf(get_2drandom_gradient(permutation, gradient, (int)int_part.val[0] + 1, (int)int_part.val[1], (int)int_part.val[2] + 1), assign_3vecf(floating_part.val[0] - 1.0, floating_part.val[1], floating_part.val[2] - 1.0));
//	double	g110 = dot_product_3vecf(get_2drandom_gradient(permutation, gradient, (int)int_part.val[0] + 1, (int)int_part.val[1] + 1, (int)int_part.val[2]), assign_3vecf(floating_part.val[0] - 1.0, floating_part.val[1] - 1.0, floating_part.val[2]));
//	double	g111 = dot_product_3vecf(get_2drandom_gradient(permutation, gradient, (int)int_part.val[0] + 1, (int)int_part.val[1] + 1, (int)int_part.val[2] + 1), assign_3vecf(floating_part.val[0] - 1.0, floating_part.val[1] - 1.0, floating_part.val[2] - 1.0));

//	double	z_quintic = quintic_poly(floating_part.val[0]);
	double	y_quintic = quintic_poly(floating_part.val[0]);
	double	x_quintic = quintic_poly(floating_part.val[1]);
//	printf("\n");
